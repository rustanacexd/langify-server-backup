...
# Copies from panta.utils because you can't call model methods in migrations
# See https://stackoverflow.com/a/37685925
...
class Migration(migrations.Migration):
    dependencies = [("panta", "0029_translatedsegment_progress")]
